...
import "../../component/CreateCaseStudy.css";
                ...
                <div className="col-lg-6 mb-4">
                    ...
                    <div className="control-group form-group">
                        <div className="controls">
                            ...
                            <input defaultValue={this.state.data ? this.state.data[0].project_name : ''} onChange={event => {this.setState({project_name:event.target.value})}} type="text" className="form-control" id="project_id"/>
                        </div>

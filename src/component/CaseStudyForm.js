...
export default class CaseStudyForm extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            client_Contact_name:'' ,client_phone: '', client_email: '', project_start_date: '',
                                            ...
                                            <div className="col-lg-12 mb-4">
                                                <div className="control-group form-group">
                                                    ...
                                                    <div className="controls">
                                                        ...
                                                        <input onChange={event => {
                                                            this.setState({client_Contact_name: event.target.value})
                                                        }} type="text" className="form-control" id="client_Contact_name"/>
                                                    </div>
